...
export const ProceduralTree = ({ position, seed }: { position: THREE.Vector3, seed: number }) => {
    ...
    return (
        <group position={position} scale={[scale, scale, scale]}>
            ...
            {/* Branch 1 */}
            <group position={[0, 6, 0]} rotation={[0, random(1) * Math.PI * 2, Math.PI / 4 + random(2) * 0.2]}>
            ...
            {/* Branch 2 */}
            <group position={[0, 8, 0]} rotation={[0, random(3) * Math.PI * 2, Math.PI / 3 + random(4) * 0.2]}>

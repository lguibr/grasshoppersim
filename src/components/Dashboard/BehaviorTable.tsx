...
import { Activity, FastForward, ArrowUpCircle, ShieldAlert } from 'lucide-react';
    ...
    <div className="bg-slate-900/50 p-4 rounded-xl border border-slate-800 h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-around gap-2">
        <div className="flex items-center justify-between">
          ...
          <span className="font-bold text-blue-400 font-mono">{(averages.jump * 100).toFixed(0)}%</span>
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-slate-400 text-sm">
          ...
          <span className="font-bold text-amber-400 font-mono">{(averages.speed * 100).toFixed(0)}%</span>
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-slate-400 text-sm">
          ...
          <span className="font-bold text-purple-400 font-mono">{(averages.height * 100).toFixed(0)}%</span>
        </div>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-slate-400 text-sm">
          ...
          <span className="font-bold text-rose-400 font-mono">{(averages.aggro * 100).toFixed(0)}%</span>
        </div>
      </div>
    </div>
  );

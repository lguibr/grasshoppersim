    ...
    return [...stats].sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case "speed":
          ...
          break;
        case "aggressiveness":
          valA = a.traits.aggressiveness;
          valB = b.traits.aggressiveness;
          break;
        case "jumpDistance":
          valA = a.traits.jumpDistance;
          valB = b.traits.jumpDistance;
          break;
        case "age":
          valA = now - a.birthTime;
          valB = now - b.birthTime;
          break;
        default:
          valA = a.id;
          valB = b.id;
    ...
    <div className="flex flex-col h-full w-full">
      <div className="flex items-center justify-between px-2 py-1 mb-2 text-[10px] uppercase font-bold text-slate-500 border-b border-slate-800">
        ...
        <div className="flex gap-3">
          ...
          >
            ENG <ArrowUpDown size={10} />
          </button>
          <button
            onClick={() => handleSort("speed")}
            className="flex items-center gap-1 hover:text-amber-400"
          >
            SPD <ArrowUpDown size={10} />
          </button>
          <button
            onClick={() => handleSort("aggressiveness")}
            className="flex items-center gap-1 hover:text-rose-400"
          >
            AGR <ArrowUpDown size={10} />
          </button>
        </div>
      </div>
      <div className="flex-1 min-h-0 w-full pr-3 relative">
        <AutoSizer
          renderProp={({ height, width }) => {
            ...
            return (
              <List
                ...
                rowHeight={34}
                rowProps={{ sortedStats, followedId, onFollow }}
                rowComponent={({
                  index,
                  style,
                  sortedStats,
